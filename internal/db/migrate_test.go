...
//
// The fixture at testdata/v0_1_0.db was generated by running
// the v0.1.0 binary against a throwaway ORBIT_HOME and seeding some data.
func TestMigrate_AdoptLegacyV010DB(t *testing.T) {
	// Copy the fixture so we never modify the committed file.
	src := filepath.Join("testdata", "v0_1_0.db")
