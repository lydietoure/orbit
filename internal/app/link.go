...
// artifacts on a work entry. Same layering as the rest
...
// ListLinks returns the artifacts linked to a work entry
// (oldest-first). An empty id falls back to the selected entry; wraps
