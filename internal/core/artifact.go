...
const (
	...
	// ArtifactNote is the local path to a markdown note file the user
...
//   - Local-path types (repo, dir, file, note) are returned trimmed but
//     NOT absolutized — that is the app layer's job (it needs the working
